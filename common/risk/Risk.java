...
public class Risk {
	...
	public <T> void rotateList(List<T> list,int offset){
	...
	/**
	 * Produces an image where all non transparent pixels in the image are converted to the given color 
	 * @param original
	 * @param c
	 * @return
	 */
	...
	public static BufferedImage flipImage(BufferedImage original, boolean flipHorizontal,boolean flipVertical){
